...
| --- | --- | --- | --- |
| **VenaGo™**
**(Enovis - EE. UU.)** | Bomba integrada en la pantorrilla
Presión preestablecida de 50 mmHg | • Actúa de forma pasiva
• No verifica esfuerzo activo del usuario | [**https://enovis.com/products/aircast/venago**](https://enovis.com/products/aircast/venago) |
| **geko™ T-3**
**(Firstkind Limited - Reino Unido)** | Wearable de electroestimulación
Tecnología OnPulse®
Provoca contracción muscular involuntaria | Aplica siempre el mismo estímulo eléctrico
No se adapta a la respuesta del paciente | [**https://geko.health/devices/](https://geko.health/devices/)**  |
| **Venowave™ VW5**
**(Therma Bright Inc. - Canadá)** | Bomba portátil a batería
Compresión mecánica de la pantorrilla
Ciclos ajustables (6-30 por minuto) | No requiere ni verifica esfuerzo muscular voluntario
No se adapta a la respuesta fisiológica real (sin sensores ni retroalimentación) | [**https://www.thermabright.com/venowave/](https://www.thermabright.com/venowave/)**  |
| **AV Impulse Foot Pump**
**(Cardinal Health - EE. UU.)** | Dispositivo neumático portátil
Impulsos de aire rápidos (cada ~20 seg)
Comprime el arco plantar del pie
Imita el bombeo natural de la marcha | No verifica cooperación del paciente
No mide respuesta hemodinámica real | [**https://www.cardinalhealth.com/en/product-solutions/medical/compression/a-v-impulse-foot-compression-system.html](https://www.cardinalhealth.com/en/product-solutions/medical/compression/a-v-impulse-foot-compression-system.html)**  |

# Revistas de catálogos de componentes

| Categoría | **Componente** | **Características** | **Precio** | **Enlace** |
| --- | --- | --- | --- | --- |
| **Captura de Cinemática Articular (Registro de Movimiento)** | **Sensor de Flexión Resistivo (Sensor Flex 2.2")** | • Tipo de salida: Analógica (variación resistiva por deformación).
...
| **Captura de Cinemática Articular (Registro de Movimiento)** | Unidad de Medida Inercial IMU 6 ejes
...
| **Captura de Cinemática Articular (Registro de Movimiento)** | **Unidad de Medida Inercial IMU 9 ejes
...
| **Monitoreo de Perfusión y Hemodinámica Venosa** | **Pulsioxímetro
...
| **Monitoreo de Perfusión y Hemodinámica Venosa** | **Sensor de pulso fotoeléctrico
...
| **Monitoreo de Perfusión y Hemodinámica Venosa** | **Convertidor de Impedancia de Múltiples Frecuencias
...
| **Detección de Activación Muscular** | **Sensor EMG** | • Tipo de salida: Analógica (Señal envolvente rectificada/integrada y/o señal EMG cruda RAW).
...
| **Detección de Activación Muscular** | **Sensor Elastomérico de Estiramiento (Stretch Sensor)** | • **Principio físico:** Variación de resistencia eléctrica por elongación mecánica lineal.
...
| **Gestión de Energía y Alimentación** | **Bateria Li-ion** | • **Química y formato:** Litio-Polímero (LiPo) flexible/plana o celda cilíndrica Li-Ion 18650.
...
| **Gestión de Energía y Alimentación** | Modulo Cargador Bateria Litio 3.7v
...
| **Gestión de Energía y Alimentación** | **Regulador de Tensión LDO (3.3V)** | • **Tipo y salida:** Regulador lineal de muy baja caída (LDO) fija a 3.3 V DC.
...
| **Procesamiento Local y Comunicaciones** | **ESP32-S3-WROOM-1** | • **Procesador:** Dual-Core Xtensa LX7 de 32 bits a 240 MHz con instrucciones vectoriales para IA.
